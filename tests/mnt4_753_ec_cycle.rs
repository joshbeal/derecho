...
fn test_verifiable_disclosure_mnt_large_ec_cycle_pcd() {
    ...
    let al_id = Fr::from_repr(BigInteger768::from(1u64)).unwrap();
    ...
    let init_amt = Fr::from_repr(BigInteger768::from(1021u64)).unwrap();
    let init_pk = Fr::from_repr(BigInteger768::from(1000u64)).unwrap();
    let init_r = Fr::from_repr(BigInteger768::from(1006u64)).unwrap();
    let deposit_pk = Fr::from_repr(BigInteger768::from(1776u64)).unwrap();
    ...
    let deposit_uid = Fr::from_repr(BigInteger768::from(1789u64)).unwrap();
    ...
    let tx_1 = ExampleTransfer::<VC> {
        out_pk: Fr::from_repr(BigInteger768::from(1001u64)).unwrap(),
        out_amt: Fr::from_repr(BigInteger768::from(1021u64)).unwrap(),
        out_rand: Fr::from_repr(BigInteger768::from(1005u64)).unwrap(),
        member_key,
        member_val,
        deposit_key,
        deposit_val,
    ...
    let tx_2 = ExampleTransfer::<VC> {
        out_pk: Fr::from_repr(BigInteger768::from(2001u64)).unwrap(),
        out_amt: Fr::from_repr(BigInteger768::from(2021u64)).unwrap(),
        out_rand: Fr::from_repr(BigInteger768::from(2005u64)).unwrap(),
        member_key,
        member_val,
        deposit_key,
        deposit_val,
