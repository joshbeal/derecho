...
#[test]
fn test_verifiable_disclosure_pasta_r1cs_snark_pcd() {
    ...
    let size_bytes_main_proof = proof_mid
        .as_ref()
        .unwrap()
        .main_nark_proof
        .serialized_size();
    let size_bytes_help_proof = proof_mid
        .as_ref()
        .unwrap()
        .help_nark_proof
        .serialized_size();
    let size_bytes_main_acc_instance = proof_mid
        .as_ref()
        .unwrap()
        .main_accumulator
        .0
        .serialized_size();
    let size_bytes_help_acc_instance = proof_mid
        .as_ref()
        .unwrap()
        .help_accumulator
        .0
        .serialized_size();
    let size_bytes_proof = size_bytes_main_proof + size_bytes_help_proof;
    println!(
        "\nStatistics about disclosure\n\n\
         Size (in bytes) of message: {size_bytes_msg}\n\
         Size (in bytes) of main accumulator instance: {size_bytes_main_acc_instance}\n\
         Size (in bytes) of help accumulator instance: {size_bytes_help_acc_instance}\n\
         Size (in bytes) of main proof: {size_bytes_main_proof}\n\
         Size (in bytes) of help proof: {size_bytes_help_proof}\n\
         Size (in bytes) of proof (total): {size_bytes_proof}\n"
    );
}
